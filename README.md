...
```yaml
helm install gerrit-operator --namespace <edp_cicd_project> --set name=gerrit-operator --set namespace=<edp_cicd_project> --set platform=<platform_type> --set image.name=epamedp/gerrit-operator --set image.version=<operator_version> --set dnsWildcard=<dns_wildcard>
```
