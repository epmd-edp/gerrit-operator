...
func (s *K8SService) CreateExternalEndpoint(g *v1alpha1.Gerrit) error {
	log.Info("CreateExternalEndpoint - Obsolete interface method. To be removed when refactored")
	return nil
}

func (s *K8SService) CreateSecurityContext(g *v1alpha1.Gerrit, sa *coreV1Api.ServiceAccount) error {
	log.Info("CreateSecurityContext - Obsolete interface method. To be removed when refactored")
	return nil
}

func (s *K8SService) CreateDeployment(g *v1alpha1.Gerrit) error {
	log.Info("CreateDeployment - Obsolete interface method. To be removed when refactored")
	return nil
}
