...
func (s *K8SService) CreateExternalEndpoint(gerrit *v1alpha1.Gerrit) error {
	return errors.New("Obsolete interface method. To be removed when refactored")
}

func (s *K8SService) CreateSecurityContext(gerrit *v1alpha1.Gerrit, sa *coreV1Api.ServiceAccount) error {
	return errors.New("Obsolete interface method. To be removed when refactored")
}

func (s *K8SService) CreateDeployment(gerrit *v1alpha1.Gerrit) error {
	return errors.New("Obsolete interface method. To be removed when refactored")
}

func (s *K8SService) IsDeploymentReady(instance v1alpha1.Gerrit) (bool, error) {
	deployment, err := s.appsV1Client.Deployments(instance.Namespace).Get(instance.Name, metav1.GetOptions{})
	if err != nil {
		return false, err
	}
